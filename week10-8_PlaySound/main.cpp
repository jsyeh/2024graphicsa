/// week10-8_PlaySound
/// 貼上 week10-7_mouse_motion_angle_myArm
#include <GL/glut.h>
...
void motion(int x, int y) { ///week10-7 加上 mouse motion
    angle = x; ///week10-7 加上 mouse motion
    glutPostRedisplay(); ///告訴GLUT,貼上便利貼,請GLUT有空時, 就要重畫畫面
}
int main(int argc, char*argv[])
{
    PlaySound("C:/happy.wav", NULL, SND_ASYNC); ///播放聲音, 檔案放在C:根目錄
	glutInit(&argc, argv);
